...
var decklogCode = document.getElementById("decklog");
var printButton = document.getElementById("printBtn");
var printValue = document.getElementById("enteredDecklog");
...
*/
function decklogToWeissSim() {
    return __awaiter(this, void 0, void 0, function () {
        var browser, page, document, cards;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    page = _a.sent();
                    return [4 /*yield*/, page.goto(decklogCode.value, {
                            waitUntil: "domcontentloaded"
                        })];
                case 3:
                    document = _a.sent();
                    return [4 /*yield*/, page.$("card-controller")];
                case 4:
                    cards = _a.sent();
                    console.log(cards);
                    return [2 /*return*/, ""];
